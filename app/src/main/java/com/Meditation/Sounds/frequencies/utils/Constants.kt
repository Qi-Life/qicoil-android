...
//        var tracks = ArrayList<Track>()
        ...
        @JvmField
        val PREF_SCHEDULE_START_TIME_AM_API = "PREF_SCHEDULE_START_TIME_AM_API"
        @JvmField
        val PREF_SCHEDULE_END_TIME_AM_API = "PREF_SCHEDULE_END_TIME_AM_API"
        @JvmField
        val PREF_SCHEDULE_START_TIME_PM_API = "PREF_SCHEDULE_START_TIME_PM_API"
        @JvmField
        val PREF_SCHEDULE_END_TIME_PM_API = "PREF_SCHEDULE_END_TIME_PM_API"
        @JvmField
        val PREF_SCHEDULE_PROGRAM_ID_API = "PREF_SCHEDULE_PROGRAM_ID_API"
